...
int main()
{
    ...
    cout << format("Profile #{}, Name {}, Age {}, Creation time {}\n", profile_1.getProfileNumber(), profile_1.getName(), profile_1.getAge(), profile_1.getCreationDate()); // Note that getCreationDate returns time in seconds from Jan 1, 1970.
    ...
    cout << format("Profile #{}, Name {}, Age {}, Creation Date {}\n", profile_2.getProfileNumber(), profile_2.getName(), profile_2.getAge(), profile_2.getCreationDate());
