...
public:
    ...
    virtual std::string getProfileNumber() const = 0;
...
public:
    StaffProfile(std::string profile_number, std::string first_name = "<unknown>", std::string last_name = "<unknown>", time_t dob = 0, std::string occupation = "<unknown>", size_t wage = 0, std::array<TimeBlock, MAXIMUM_STORED_SHIFTS> shifts = {}, Unit asssigned_unit = GENERAL, std::vector<std::string> assigned_rooms = {}) :
        m_profile_number{ profile_number }, m_first_name{ first_name }, m_last_name{ last_name }, m_dob{ dob }, m_occupation{ occupation }, m_wage{ wage }, m_shifts{ shifts }, m_assigned_unit{ asssigned_unit }, m_assigned_rooms{ assigned_rooms }, m_creation_date{ time_t(0) } {
    }

    StaffProfile(std::string profile_number, std::string first_name, std::string last_name, time_t dob, std::string occupation, size_t wage, time_t creation_date, std::array<TimeBlock, MAXIMUM_STORED_SHIFTS> shifts, Unit asssigned_unit, std::vector<std::string> assigned_rooms) :
